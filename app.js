...
async function syncGoogle(){
  ...
  try{
    // Als normales Form-POST senden: keine CORS-Preflight-Anfrage an Apps Script.
    const body=new URLSearchParams();
    body.set('payload',JSON.stringify(payload));
    await fetch(u,{method:'POST',mode:'no-cors',headers:{'Content-Type':'application/x-www-form-urlencoded;charset=UTF-8'},body:body.toString()});
