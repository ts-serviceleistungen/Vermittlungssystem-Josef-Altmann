...
function renderAuth(){if(currentUser){$('#loginView').classList.add('hidden');$('#appView').classList.remove('hidden');$('#userName').textContent=currentUser.email||'';navigate(localStorage.getItem('vermittlung_last_page')||'dashboard');}else{$('#appView').classList.add('hidden');$('#loginView').classList.remove('hidden');}}
